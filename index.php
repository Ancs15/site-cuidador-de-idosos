...
if(isset($_POST['email'])){
  ...
  try {
      ...
      $nome     =       $_POST["nome"];
      // $ = Guarda em variável
      // $_POST = Pega o valor post do formulário
      $email    =       $_POST["email"];
      $tele     =       $_POST['tele'];
      $mens     =       $_POST['mens'];
      ...
      // require_once = chama um arquivo.php

      $contato = new ClasseContato();
      // new: Cria uma nova classe
      ...
      //Recipients
      $mail->setFrom('seniorlifesp@gmail.com', 'Site Senior Life SP'); //troca isso aqui
...
<body>
    ...
    <main>
        ...
        <a href="https://wa.me/5511999999999?text=Olá!+Gostaria+de+falar+sobre+seus+serviços" target="_blank" class="btn-whatsapp"><img src="assets/whatsapp-24.png" alt="Botão Flutuante para Whatsapp"></a>
    </main>
